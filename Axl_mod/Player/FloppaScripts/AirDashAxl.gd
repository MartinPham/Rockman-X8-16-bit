extends DashFloppaAxl
class_name AirDashFloppaAxl
...
func _StartCondition() -> bool:
	...
	if character.get_action_pressed("move_up") and (character.get_action_pressed("move_right") or character.get_action_pressed("move_left")):
		return false
