...
onready var _sprites_pistol_A: Resource = preload("res://Axl_mod/Player/Sprites/axl.res")
onready var _sprites_pistol_B: Resource = preload("res://Axl_mod/Player/Sprites/axl_pistol.res")
