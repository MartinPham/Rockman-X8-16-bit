...
onready var _sprites_pistol_A: Resource = preload("res://Axl_mod/Player/PalletteSprites/pallette.tres")
onready var _sprites_pistol_B: Resource = preload("res://Axl_mod/Player/PalletteSprites/pallette.tres")

onready var _sprites_raygun: Resource = preload("res://Axl_mod/Player/PalletteSprites/ray_gun/ray_gun.tres")

onready var _sprites_sprialmagnum_A: Resource = preload("res://Axl_mod/Player/PalletteSprites/spiral_magnum/spiral_magnum_A.tres")
onready var _sprites_spiralmagnum_B: Resource = preload("res://Axl_mod/Player/PalletteSprites/spiral_magnum/spiral_magnum_B.tres")

onready var _sprites_blackarrow: Resource = preload("res://Axl_mod/Player/PalletteSprites/black_arrow/black_arrow.tres")

onready var _sprites_plasmagun: Resource = preload("res://Axl_mod/Player/PalletteSprites/plasma_gun/plasma_gun.tres")

onready var _sprites_blastlauncher_A: Resource = preload("res://Axl_mod/Player/PalletteSprites/blast_launcher/blast_launcher_A.tres")
onready var _sprites_blastlauncher_B: Resource = preload("res://Axl_mod/Player/PalletteSprites/blast_launcher/blast_launcher_B.tres")

onready var _sprites_boundblaster_A: Resource = preload("res://Axl_mod/Player/PalletteSprites/bound_blaster/bound_blaster.tres")
onready var _sprites_boundblaster_B: Resource = preload("res://Axl_mod/Player/PalletteSprites/bound_blaster/bound_blaster.tres")

onready var _sprites_icegattling_1: Resource = preload("res://Axl_mod/Player/PalletteSprites/ice_gattling/ice_gattling_1.tres")
onready var _sprites_icegattling_2: Resource = preload("res://Axl_mod/Player/PalletteSprites/ice_gattling/ice_gattling_2.tres")
onready var _sprites_icegattling_3: Resource = preload("res://Axl_mod/Player/PalletteSprites/ice_gattling/ice_gattling_3.tres")
onready var _sprites_icegattling_4: Resource = preload("res://Axl_mod/Player/PalletteSprites/ice_gattling/ice_gattling_4.tres")

onready var _sprites_flameburner: Resource = preload("res://Axl_mod/Player/PalletteSprites/flame_burner/flame_burner.tres")
...
func equip_pallette_parts() -> void :
	...
	get_node("DashWallJump").horizontal_velocity = 220
	get_node("DashJump").horizontal_velocity = 220
	get_node("Fall").dash_momentum = 220
...
func equip_parts(collectible: String) -> void :
	CharacterManager.set_pallette_colors(animatedSprite)
	equip_pallette_parts()
