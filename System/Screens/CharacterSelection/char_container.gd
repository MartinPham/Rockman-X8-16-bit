...
\
\
"\n\n[color=#47a1fc]Head:[/color]\nDNA Copy system for X Buster.\n\n[color=#47a1fc]Arm:[/color]\nX-Buster MK17, fires chargeable solar energy.\n\n[color=#47a1fc]Body:[/color]\nTitanium X Alloy, highly damage-resistant.\n\n[color=#47a1fc]Legs:[/color]\nAir Dash system for aerial travel."
...
\
\
"\n\nMagnum Opus of Dr. Thomas Light. Origin of all Reploid-kind.\n\nAn all-round Hunter who can attack at a long range.\n\n\nA good choice for beginner players."
...
\
\
"\n[color=#47a1fc]Head:[/color]\nLearns new techniques from combat.\n\n[color=#47a1fc]Z-Saber:[/color]\nA sharp sword for multi-strike combos.\n\n[color=#47a1fc]Body:[/color]\nImproves mobility and boosts energy for powerful moves.\n\n[color=#47a1fc]Air Waltz:[/color]\nMid-air second jump with thrusters."
...
\
\
"\n\nLeads the Hunters in X’s absence, with ties to the Sigma Virus.\n\nThis powerful Hunter is a skilled close-combat fighter.\n\nA good choice for experienced players."
...
\
\
"\n\n[color=#47a1fc]Copy Chip:[/color]\nAllows Axl to copy enemy abilities.\n\n[color=#47a1fc]Axl Bullet:[/color]\nFires rapid, powerful bullets.\n\n[color=#47a1fc]Lightweight Frame:[/color]\nIncreases mobility and enables dodging ability.\n\n[color=#47a1fc]Hover:[/color]\nAllows hovering in mid-air."
...
\
\
"\n\nA quick and versatile Hunter with the ability to copy enemy abilities.\n\nHis agility makes him highly mobile and allows him to dodge enemy attacks.\n\nA good choice for adaptable players."
