...
func _ready() -> void :
	_on_focus_exited()
	icon.material.set_shader_param("grayscale", not CharacterManager.auto_charge)
...
func toggle_auto_charge() -> void :
	CharacterManager.auto_charge = not CharacterManager.auto_charge
	if CharacterManager.auto_charge:
