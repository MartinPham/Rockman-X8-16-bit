...
func _Update(delta: float) -> void :
	...
	if attack_stage == 0:
		...
		#CharacterManager.set_awakened_effect_red(animatedSprite)
		next_attack_stage()
	...
	if attack_stage == 1 and has_finished_last_animation():
		...
		character.recover_health(15)
		#if CharacterManager.player_character == "X":
		#	CharacterManager.set_zeroX8_normal_colors(animatedSprite)
		#	CharacterManager.set_saber_beta_green(animatedSprite)
		#elif CharacterManager.player_character == "Zero":
		#	CharacterManager.set_omega_zeroX8_colors(animatedSprite)
		#	CharacterManager.set_saber_omega_pink(animatedSprite)
		#elif CharacterManager.player_character == "Axl":
		#	CharacterManager.set_new_betazero_fake_colors(animatedSprite)
		#	CharacterManager.set_saber_beta_red(animatedSprite)
