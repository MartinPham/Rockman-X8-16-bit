...
func _ready() -> void :
	if CharacterManager.only_x:
		CharacterManager.set_zeroX8_normal_colors(animated_sprite)
		CharacterManager.set_saberX8_green(animated_sprite)
	if CharacterManager.only_zero:
		CharacterManager.set_omega_zeroX8_colors(animated_sprite)
		CharacterManager.set_saber_omega_pink(animated_sprite)
	if CharacterManager.only_axl:
		CharacterManager.set_new_betazero_fake_colors(animated_sprite)
		CharacterManager.set_saberX8_red(animated_sprite)
