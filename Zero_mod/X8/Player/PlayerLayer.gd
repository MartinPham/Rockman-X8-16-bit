...
onready var _saber_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layer.tres")
onready var _fan_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layerbfan.tres")
onready var _glaive_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layerdglaive.tres")
onready var _knuckle_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layerknuckle.tres")
onready var _breaker_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layertbreaker.tres")
onready var _sigmablade_sprites: Resource = preload("res://Zero_mod/X8/LayerSprites/layersigmablade.tres")
...
var execute_genmuzero: bool = false
...
func combo_connection_hyouryuushou() -> bool:
	if get_action_pressed("dash"):
		return false
	if saber_node.current_weapon.name == "Saber" or saber_node.current_weapon.name == "D-Glaive" or saber_node.current_weapon.name == "Sigma-Blade":
		var _animation = get_animation()
...
func change_ride_chaser_sprites() -> void :
	var _texture = load("res://Zero_mod/X8/LayerSprites/Ride/layer_ride_chaser.png")
	var _reference_frames = load("res://Zero_mod/X8/LayerSprites/layer.tres")
...
func equip_parts(collectible: String) -> void :
	CharacterManager.set_layer_colors(animatedSprite)
	equip_layer_parts()
