...
onready var ability_animation: Resource = preload("res://Zero_mod/X8/Sprites/Saber/BossAbilities/ability_effects.tres")

onready var _saber_sprites: Resource = preload("res://Zero_mod/X8/Sprites/Saber/zerox8.tres")
...
onready var _hanger_sprites: Resource = preload("res://Zero_mod/X8/Sprites/vhanger/vhanger.tres")
onready var _zbuster_sprites: Resource = preload("res://Zero_mod/X8/Sprites/zbuster/zbuster.tres")
onready var _rogueblade_sprites: Resource = preload("res://Zero_mod/X8/Sprites/rogueblade/rogueblade.tres")
onready var _sigmablade_sprites: Resource = preload("res://Zero_mod/X8/Sprites/sigmablade/sigmablade.tres")
onready var _genmuzero_sprites: Resource = preload("res://Zero_mod/X8/Sprites/Saber/zerox8.tres")
...
func combo_connection_hyouryuushou() -> bool:
	if get_action_pressed("dash"):
		return false
	if saber_node.current_weapon.name == "Saber" or saber_node.current_weapon.name == "D-Glaive" or saber_node.current_weapon.name == "Rogue-Blade" or saber_node.current_weapon.name == "Sigma-Blade":
		var _animation = get_animation()
		if _animation == "saber_1" and animatedSprite.frame >= 7:
			...
			return true
		elif _animation == "saber_4" and animatedSprite.frame >= 8:
			return true
		elif _animation == "saber_5" and animatedSprite.frame >= 10:
			return true
		elif _animation == "saber_6" and animatedSprite.frame >= 6:
			return true
	return false
...
func _ready() -> void :
	...
	if not "genmuzero_zero" in GameManager.collectibles:
		GameManager.add_collectible_to_savedata("genmuzero_zero")

func change_ride_chaser_sprites() -> void :
	var _texture = load("res://Zero_mod/X8/Sprites/Ride/zero_ride_chaser.png")
	var _reference_frames = load("res://Zero_mod/X8/Sprites/Saber/zerox8.tres")
...
#mu barrier damages reduction#

func equip_mu_barrier_parts() -> void :
	var dmg = get_node("Damage")
	dmg.damage_reduction = 99
	dmg.prevent_knockbacks = true
	dmg.conflicting_moves = ["Death", "Nothing"]

func cancel_mu_barrier_parts() -> void :
	if CharacterManager.black_zero_armor and not CharacterManager.awakened_zero_armor:
	...
	elif CharacterManager.awakened_zero_armor and not CharacterManager.awakened_zero_full_power_max:
		var dmg = get_node("Damage")
		dmg.damage_reduction = 80
		dmg.prevent_knockbacks = true
		dmg.conflicting_moves = ["Death", "Nothing"]
		...
		dmg.prevent_knockbacks = true
		dmg.conflicting_moves = ["Death", "Nothing"]
		Tools.timer(0.2, "set_normal", self)
