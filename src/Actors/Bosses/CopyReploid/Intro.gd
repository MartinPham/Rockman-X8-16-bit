...
const new_death: PackedScene = preload("res://src/Actors/Enemies/Shared/TurnReploidDeath.tscn")

onready var physics: Physics = Physics.new($"..")
onready var animation: AnimationController = AnimationController.new($"../animatedSprite", self)
onready var stage: AbilityStage = AbilityStage.new(self)
