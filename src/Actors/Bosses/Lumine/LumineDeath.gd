...
func play_death_end() -> void :
	animation.play("death_end")

func set_fullscreen_light() -> void :
...
func set_light_alpha(value: float) -> void :
	light.material.set_shader_param("Alpha", value)

func set_light_color(value: float) -> void :
