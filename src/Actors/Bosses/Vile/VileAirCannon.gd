...
export  var prepare_anim: String = "flight_cannon_prepare"
export  var shot_anim: String = "flight_cannon_fire"
export  var end_anim: String = "flight_cannon_end"
export  var shots: int = 9
