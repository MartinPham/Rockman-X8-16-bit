...
func manage_mashing() -> void :
	if Input.is_action_just_pressed("fire") or Input.is_action_just_pressed("alt_fire") or Input.is_action_just_pressed("jump") or Input.is_action_just_pressed("dash") or Input.is_action_just_pressed("move_left") or Input.is_action_just_pressed("move_right") or Input.is_action_just_pressed("move_up") or Input.is_action_just_pressed("move_down"):
		mashes_pressed += 1
