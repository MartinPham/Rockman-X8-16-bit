...
func has_reached_player() -> bool:
	return is_player_nearby_horizontally(nearby_distance.x) and is_player_nearby_vertically(nearby_distance.y)

func is_player_far_away() -> bool:
	return not is_player_nearby_horizontally(300.0) or not is_player_nearby_vertically(100.0)
