...
export  var dont_deal_damage: bool = false
export  var previous_combo: NodePath
export  var damage_in_combo: float = 3.0

var hit_through_invulnerability: bool = false
...
func connect_combo(_previous_combo) -> void :
