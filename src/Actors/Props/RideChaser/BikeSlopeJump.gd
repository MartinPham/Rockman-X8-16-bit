...
func decay_buildup_based_on_speed(delta: float) -> void :
...
func has_exited_slope() -> bool:
	return character.is_going_down_on_slope() or is_on_level_plane() or not character.is_colliding_with_ground()
