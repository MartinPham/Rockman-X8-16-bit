...
const bike: PackedScene = preload("res://src/Actors/Props/RideChaser/RideChaser.tscn")
const ridearmor: PackedScene = preload("res://src/Actors/Props/RideArmor/RideArmor.tscn")
