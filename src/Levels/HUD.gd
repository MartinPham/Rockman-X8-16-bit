...
onready var boss_bar: NinePatchRect = $"Boss Bar"
onready var boss_hp: TextureProgress = $"Boss Bar/textureProgress"

onready var player_bar: NinePatchRect = $"X Bar"
...
onready var white_screen: ColorRect = $WhiteScreen

var boss_hp_filled: bool = false
var boss_filling_hp: = 0
var boss
var action_debug: bool = false
var action_debug2: bool = false
var frame_skip: int = 1
var black_screen_alpha: float = 1.4
var fade_out: bool = false
var current_time: float = 0.0

var playerbar_blinking: bool = false
var blink_timer: float = 0.0
var debugging_character
var chronometering: bool = true
...
func _ready() -> void :
	rec_info.text = GameManager.codename + " " + GameManager.version + " " + GameManager.current_demo
	...
	call_deferred("connect_igt")
	call_deferred("on_showigt", "ShowIGT")

onready var time_container = $IGTHUD
func connect_igt():
...
func show_igt(show: bool = true) -> void :
	if time_container:
		time_container.visible = show

func connect_debug() -> void :
...
func show_debug(show: bool = true) -> void :
	x_info.visible = show
	i_info.visible = show
	b_info.visible = show
...
func change_camera_focus(new_focus) -> void :
...
func tween_focus_on_bar(focus_bar, other_bar, x_pos, color) -> void :
		...
		ride_hp_tween.tween_property(focus_bar, "rect_position:x", 8, 0.2)
...
func setup_boss_health(_boss) -> void :
	boss = _boss
...
var fade_out_to_white: bool = false
...
func on_healable_amount(param) -> void :
	call_deferred("show_healable_amount", param)

func show_healable_amount(healable_amount) -> void :
...
func show_boss_health_and_weapon(delta: float) -> String:
	var text: = ""
	if is_instance_valid(GameManager.player):
...
func fill_boss_hp(_delta: float) -> void :
